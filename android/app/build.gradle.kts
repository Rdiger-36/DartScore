...
android {
    namespace = "com.dartscore.dartscore_app"
    compileSdk = 36
    ...
    defaultConfig {
        ...
        applicationId = "com.dartscore.dartscore_app"
    ...
    buildTypes {
        release {
            // Fall back to debug signing only when key.properties is absent (e.g. CI without
            // secrets or a fresh checkout), so local debug builds keep working.
